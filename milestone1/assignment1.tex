...
\noindent
Write a module \verb!sql2ra! that takes a parsed SQL statement and performs the canonical translation into relational algebra, using the operators $\sigma$, $\pi$, $\times$, and $\rho$.
...
\noindent
This milestone specification comes with a file \verb!test_sql2ra.py! which contains unit tests. Make sure your implementation passes these tests.
