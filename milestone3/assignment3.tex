...
%\newcommand{\examdate}{Last updated 04-MAY-18}
\usepackage{paralist}
\usepackage{fancyvrb}
...
We assume that the queries are the output of milestone~2 and therefore use the operators $\sigma$, $\pi$, $\rho$, and $\bowtie$ only. (We do not implement the cross product as a MapReduce job, it doesn't make much sense for {\em big}\/ data.)
